...
Status: proposed on 2026-09-21 against main `a9e3c0b`. Implements the next three
...
plan; the forecasts below are not measurements of implemented optimizations.
