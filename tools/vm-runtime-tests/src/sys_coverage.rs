...
const EXECUTED: &[(&str, &str)] = &[
    ...
    ("StrR", "native_real_library.act"),
    ("ValR", "native_real_library.act"),
    ...
    ("PrintR", "resident_numeric_output.act"),
    ("PrintRE", "resident_numeric_output.act"),
    ("PrintRD", "resident_numeric_output.act"),
    ("PrintRDE", "resident_numeric_output.act"),
    ...
    ("InputR", "resident_console_input.act"),
    ("InputRD", "resident_console_input.act"),
