...
IMPLIED = {0x0a:'ASL A',0x4a:'LSR A',0xc8:'INY',0x18:'CLC',0x38:'SEC',0x1b:'TCS',0x3b:'TSC',0xaa:'TAX',0xa8:'TAY',0x98:'TYA',0x8a:'TXA',0xeb:'XBA',0x4b:'PHK',0x48:'PHA',0x3a:'DEC A',0x6b:'RTL',0xca:'DEX',0xe8:'INX'}
DP = {0xa6:'LDX',0xa5:'LDA',0x85:'STA',0x65:'ADC',0xe5:'SBC',0xc5:'CMP',0x25:'AND',0x05:'ORA',0x45:'EOR',0x06:'ASL',0x26:'ROL',0x46:'LSR',0x66:'ROR'}
IMMEDIATE = {0xa9:'LDA',0x69:'ADC',0xe9:'SBC',0xc9:'CMP',0x29:'AND',0x09:'ORA',0x49:'EOR',0xa0:'LDY',0xa2:'LDX',0xe0:'CPX'}
LONG = {0xaf:'LDA',0x8f:'STA',0x5c:'JML',0x22:'JSL'}
BRANCH = {0x10:'BPL',0x30:'BMI',0x50:'BVC',0x70:'BVS',0x90:'BCC',0xb0:'BCS',0xd0:'BNE',0xf0:'BEQ',0x80:'BRA'}
STACK = {0xa3:'LDA',0x83:'STA',0x63:'ADC',0xe3:'SBC',0xc3:'CMP',0x23:'AND',0x03:'ORA',0x43:'EOR'}
    ...
    for segment in image['segments']:
        ...
        while at<len(code):
            ...
            if opcode in IMPLIED:text=IMPLIED[opcode]
                ...
                text=f'BRL ${(base&0xff0000)|((base+at+delta)&0xffff):06X}'
            elif opcode==0x62:
                delta=operand(2);delta=delta if delta<32768 else delta-65536
