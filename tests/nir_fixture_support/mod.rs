...
pub const NIR_FIXTURE_CASES: &[NirFixtureCase] = &[
    ...
    lowered_atari_case!("inline_scratch"),
    optimized_atari_case!("inline_scratch"),
    ...
    lowered_atari_case!("aggregate_indirect"),
    ...
    optimized_atari_case!("case_guards"),
    ...
    lowered_atari_case!("enum_values"),
    optimized_atari_case!("enum_values"),
    lowered_atari_case!("enum_calls"),
    optimized_atari_case!("enum_calls"),
    ...
    lowered_atari_case!("case_variant_value"),
    optimized_atari_case!("case_variant_value"),
    lowered_atari_case!("case_variant_dynamic"),
    optimized_atari_case!("case_variant_dynamic"),
