//! The encoder has no VM memory map and lowers for every target.
use actionc::{
...
#[test]
fn adpcm_enc_uses_ordinary_storage_and_lowers_to_all_target_mirs() {
    let path = Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("fixtures/runtime/tacle/adpcm_enc/adpcm_enc.act");
